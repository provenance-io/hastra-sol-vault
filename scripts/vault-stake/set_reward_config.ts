 ...
 *
 * Unified admin script to update one or more StakeRewardConfig fields on vault-stake.
 * Any provided flag is applied in sequence using the corresponding on-chain instruction.
 *
 * Usage:
 *   ANCHOR_PROVIDER_URL=http://127.0.0.1:8899 ANCHOR_WALLET=~/.config/solana/id.json \
 *   yarn ts-node scripts/vault-stake/set_reward_config.ts \
 *     --max_reward_bps 120 \
...
async function main() {
    ...
    console.log("=== set_reward_config (vault-stake) ===\n");
