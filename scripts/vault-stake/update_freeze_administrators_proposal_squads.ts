 ...
 *   yarn ts-node scripts/vault-stake/update_freeze_administrators_proposal_squads.ts \
...
async function main() {
    ...
    console.log("=== update_freeze_administrators Squads Proposal (v4 SDK, vault-stake) ===\n");
    ...
    console.log(`   4. Confirm freeze_administrators on stake_config ${stakeConfigPda.toBase58()}`);
}
