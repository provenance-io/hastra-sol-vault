...
solana airdrop 1000 --keypair ~/temp/freeze_admin1.json --url l
...
USDC_VAULT_TOKEN_ACCOUNT=$(spl-token create-account $USDC_TOKEN --owner ~/temp/freeze_admin1.json 2>&1 | grep "Creating account" | awk '{print $3}')
