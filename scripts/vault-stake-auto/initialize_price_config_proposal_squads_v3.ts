/**
 * initialize_price_config_proposal_squads_v3.ts
 *
 * Creates a Squads v3 (SMPLecH534NA9acpos4G6x7uf3LWbCAwZQE9e8ZekMu) transaction
 * proposal to call initialize_price_config on the vault-stake-auto program.
 *
 * Use this script when the multisig is a Squads v3 multisig.  The standard
 * initialize_price_config_proposal.ts uses the Squads v4 SDK, which will
 ...
 *   yarn ts-node scripts/vault-stake-auto/initialize_price_config_proposal_squads_v3.ts \
...
async function main() {
    ...
    // This should equal ATAkatkGWPDNdhLmeqd1PPdG6h7af5kkmivisuqVvX3K for the
    // devnet multisig FftEXgzqaJNm8A6ynAmyfixBpHZtEJNr22q4KvUydByB.
    ...
    console.log("=== initialize_price_config Squads v3 Proposal ===\n");
    ...
    // --- Build inner initialize_price_config instruction -----------------------
    //
