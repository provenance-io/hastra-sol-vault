 ...
 * on vault-stake-auto. Any provided flag is converted into an inner instruction and all
 * selected updates are batched into one proposal transaction.
 *
 * Usage:
 *   ANCHOR_PROVIDER_URL=https://api.devnet.solana.com \
 *   ANCHOR_WALLET=~/.config/solana/squad-member.json \
 *   yarn ts-node scripts/vault-stake-auto/set_reward_config_proposal_squads_v3.ts \
...
async function main() {
    ...
    console.log("=== set_reward_config Squads v3 Proposal (vault-stake-auto) ===\n");
