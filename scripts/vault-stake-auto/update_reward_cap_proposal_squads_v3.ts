 ...
 * on the vault-stake-auto program. Requires the upgrade authority (Squads vault PDA)
 ...
 *   yarn ts-node scripts/vault-stake-auto/update_reward_cap_proposal_squads_v3.ts \
