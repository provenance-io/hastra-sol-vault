 ...
 *
 * Calls `update_reward_config` on the vault-stake-auto program with the connected wallet as signer.
 ...
 *   yarn ts-node scripts/vault-stake-auto/migrate_stake_config_pda.ts --max_reward_bps 75
 */
...
async function main() {
    ...
    console.log("=== migrate_stake_config_pda (vault-stake-auto) ===\n");
