 ...
 *   yarn ts-node scripts/vault-mint/update_rewards_administrators_proposal_squads.ts \
...
async function main() {
    ...
    console.log("=== update_rewards_administrators Squads Proposal (v4 SDK, vault-mint) ===\n");
    ...
    console.log(`   4. Confirm rewards_administrators on config ${configPda.toBase58()}`);
}
