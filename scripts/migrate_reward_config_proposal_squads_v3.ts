/**
 * migrate_reward_config_proposal_squads_v3.ts
 *
 * Creates a Squads v3 proposal to call `update_reward_config` to realloc/migrate the
 * `stake_reward_config` PDA in-place.
 *
 * Supports both pools:
 * - prime = vault-stake
 ...
 *   yarn ts-node scripts/migrate_reward_config_proposal_squads_v3.ts \
 *     --pool prime \
